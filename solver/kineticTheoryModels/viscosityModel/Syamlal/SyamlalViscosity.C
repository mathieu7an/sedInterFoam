...
Foam::tmp<Foam::volScalarField> Foam::kineticTheoryModels::SyamlalViscosity::mus
(
...
) const
{
    ...
    (
      ...
      + (1.0/15.0)*sqrtPi*g0*(1.0 + e)*(3.0*e - 1.0)*sqr(alphas)/(3.0 - e)
      + (1.0/6.0)*alphas*sqrtPi/(3.0 - e)
    );
}
