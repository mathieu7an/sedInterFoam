...
{
    return 0.6/mag(1.0 - pow(alphas/alphasMax, 1.0/3.0));
}
...
{
    return (1.0/5.0)*pow(max(alphas, scalar(1e-9))/alphasMax, -2.0/3.0)
          /(alphasMax*sqr(1.0 - pow(alphas/alphasMax, 1.0/3.0)));
}
